"""
CodeMaster has just returned from shopping. He scanned the check
   of the items he bought and gave the resulting string to
...
def sumUpNumbers(inputString):
    return sum(int(i) for i in re.split("[^0-9]", inputString) if i.isdigit())
